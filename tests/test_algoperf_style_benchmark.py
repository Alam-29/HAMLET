...
from main.run_algoperf_style_benchmark import search_space, write_alignment_note
...
class AlgoPerfStyleBenchmarkTests(unittest.TestCase):
    ...
    def test_alignment_note_marks_results_as_local_not_official(self) -> None:
        class Args:
