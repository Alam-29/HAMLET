...
|---|---:|---:|---:|---:|---|
| hamiltonian_geometric | 3 | 0.0402668273809 | 0.9933 | 1.1009 | `{'learning_rate': 0.03, 'beta': 0.9, 'memory_coupling': 0.001, 'metric_decay': 0.99, 'metric_epsilon': 1e-08, 'weight_decay': 0.0001}` |
| adamw | 5 | 0.047775547018 | 0.9933 | 1.2831 | `{'learning_rate': 0.03, 'beta1': 0.9, 'beta2': 0.999, 'weight_decay': 0.0001}` |
| nag | 6 | 0.084290791259 | 0.9767 | 1.0239 | `{'learning_rate': 0.06, 'momentum': 0.9, 'weight_decay': 0.0001}` |
| heavy_ball | 6 | 0.0848794337147 | 0.9767 | 0.9105 | `{'learning_rate': 0.06, 'momentum': 0.9, 'weight_decay': 0.0001}` |
